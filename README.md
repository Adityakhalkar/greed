...
[![Version](https://img.shields.io/badge/version-2.1.2-blue.svg)](https://github.com/adityakhalkar/greed)
...
```html
<!-- CDN -->
<script src="https://unpkg.com/greed.js@2.1.2/dist/greed.min.js"></script>
```
