...
[![Version](https://img.shields.io/badge/version-2.1.3-blue.svg)](https://github.com/adityakhalkar/greed)
...
```html
<!-- CDN -->
<script src="https://unpkg.com/greed.js@2.1.3/dist/greed.min.js"></script>
```
